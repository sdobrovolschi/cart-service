...
public class EmbeddedServiceBootstrapConfiguration {
    ...
    @Bean
    public ServiceContainer service(ConfigurableEnvironment environment, Network network, ServiceProperties properties) {
        ...
        var service = new ServiceContainer(properties.getDockerImage())
                ...
                .waitingFor(Wait.forHttp(properties.getReadinessProbe())
